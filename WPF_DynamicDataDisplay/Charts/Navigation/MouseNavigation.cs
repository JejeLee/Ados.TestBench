...
namespace Microsoft.Research.DynamicDataDisplay.Navigation
{
	...
	public class MouseNavigation : NavigationBase
	{
		...
		private void MouseWheelZoom(Point mousePos, int wheelRotationDelta)
		{
            ...
            if (zoomY == false)
            {
                zoomedRect.Y = Viewport.Visible.Y;
                zoomedRect.Height = Viewport.Visible.Height;
            }
            if (zoomX == false)
            {
                zoomedRect.X = Viewport.Visible.X;
        ...
        // 2014-02-22 - MPEKALSKI - added property to make possible   limiting on zoom on only one axis
        static private bool _zoomX = true;
        /// <summary>
        /// Property for allowing/disallowing for zoom along X axis. By default allowed (true).
        /// </summary>
        static public bool zoomX
        {
            get { return _zoomX; }
            set { _zoomX = value; }
        }
        static private bool _zoomY = true;
        /// <summary>
        /// Property for allowing/disallowing for zoom along Y axis. By default allowed (true).
        /// </summary>
        static public bool zoomY
        {
            get { return _zoomY; }
            set { _zoomY = value; }
        }
